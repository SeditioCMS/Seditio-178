...
Type=Core
Author=Seditio Team
Description=Türkçe kurulum dil dosyası
[END_SED]
==================== */
...
$L['install_see_yourhosting'] = "Bunun için barındırma kontrol panelinize bakın";
...
$L['install_seditio_already'] = "Bu veritabanında zaten bir Seditio'nuz yoksa değiştirmeyin";
$L['install_input_mode'] = "Metin alanları için giriş modu :";
$L['install_html_mode'] = "<strong>HTML</strong> (önerilen)<br /> \n
           Sayfalar, forumlardaki gönderiler ve özel mesajlar için metin alanları doğal olarak HTML kodu olarak işlenir.<br />\n
           Bir WYSIWYG HTML düzenleyicisi otomatik olarak yüklenecek.";
$L['install_bbcode_mode'] = "<strong>BBcode</strong><br />
          Sayfalar, forumlardaki gönderiler ve özel mesajlar için metin alanları ham metin ve [bbcode] etiketleri olarak işlenir..<br />\n
         Bir satır içi BBcode düzenleyicisi otomatik olarak yüklenecek.";
$L['install_skinandlang'] = "Tema ve dil :";
$L['install_default_skin'] = "Default skin :<br />(Skins dosyaları /skins/ klasöründe saklanır...";
$L['install_default_lang'] = "Default dil :";
$L['install_admin_account'] = "Yönetici hesabı :";
$L['install_account_name'] = "Hesap adı :";
$L['install_ownaccount_name'] = "Kendi hesap adınız";
