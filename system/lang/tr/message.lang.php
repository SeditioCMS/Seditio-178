...
$L['msg105_1'] = "Lütfen posta kutunuzu birkaç dakika içinde kontrol edin,<br />ve lütfen kayıt işlemini onaylayın<br />mesajdaki URL'yi tıklayarak ...<br />Bu zamana kadar hesabınız kullanıcı listesinde 'Etkin değil' olarak işaretlenir..";
...
$L['msg153_0'] = "Oturum açılamadı (kullanıcı yasaklandı)";
...
$L['msg303_1'] = "Bir hata oluştu, gerekli alanlardan biri/birileri doldurulmadı veya yanlış dolduruldu.";
...
$L['msg502_1'] = "Tamamlandı, özel mesajınız başarıyla gönderildi.<br />Tıklayın ";
$L['msg502_2'] = "buraya";
...
$L['msg916_1'] = "Bitti, veritabanı başarıyla güncellendi.<br />Etkilenen girişler : $num";
